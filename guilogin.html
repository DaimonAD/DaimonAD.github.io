...
<!-- saved from url=(0042)http://forum.minecraft-galaxy.ru/guilogin/ -->
<html style="overflow: auto;"><head><meta http-equiv="Content-Type" content="text/html; charset=UTF-8">
	...
	<link rel="stylesheet" href="./guilogin_files/style.css" type="text/css">
	<link rel="stylesheet" href="./guilogin_files/red.css" type="text/css">	<link rel="stylesheet" href="./guilogin_files/adaptive.css" type="text/css">
	
	<meta property="og:image" content="http://minecraft-galaxy.ru/img/logo_large.png"> 
	<script type="text/javascript" async="" src="./guilogin_files/ga.js.Без названия"></script><script type="text/javascript" src="./guilogin_files/jquery.min.js.Без названия"></script> 
	<script type="text/javascript" src="./guilogin_files/jquery-ui.min.js.Без названия"></script> 
	
	<script type="text/javascript" src="./guilogin_files/jquery.autocomplete.js.Без названия"></script>
	
	<script type="text/javascript" src="./guilogin_files/script.js.Без названия"></script>
	<script type="text/javascript" src="./guilogin_files/format.js.Без названия"></script>
	<script src="./guilogin_files/script.js(1).Без названия"></script>
	
	<script type="text/javascript" src="./guilogin_files/ThreeCanvas.js.Без названия"></script>
	<script type="text/javascript" src="./guilogin_files/Cube.js.Без названия"></script>
	<script type="text/javascript" src="./guilogin_files/BinFileReader.js.Без названия"></script><script type="text/vbscript">
...
<script src="./guilogin_files/saved_resource"></script><script src="./guilogin_files/saved_resource"></script><script src="./guilogin_files/saved_resource"></script><style type="text/css">/*
...
<div class="mobile-showen-menu-back" style="display: none;"><div class="mobile-showen-menu" style="display: none;"><ul class="mobilemenu"><li><a class="item mobile-menu-item" href="http://forum.minecraft-galaxy.ru/">Форумы</a></li><li><a class="item mobile-menu-item" href="http://forum.minecraft-galaxy.ru/forum/0">Темы ↓</a>								<ul class="dropdown-mobile">
			...
			<ul class="tabs mainmenu"><li><a class="item" href="http://forum.minecraft-galaxy.ru/">Форумы</a></li><li><a class="item" href="http://forum.minecraft-galaxy.ru/forum/0">Темы ↓</a>						<ul class="dropdown">
					...
					</li><li><a class="item" href="http://forum.minecraft-galaxy.ru/guilogin/#"><img src="./guilogin_files/map.png" width="10"> Карты ↓</a>						<ul class="dropdown large">
					...
					</li><li><a class="item" href="http://forum.minecraft-galaxy.ru/search/">Поиск</a></li><li><a class="item" href="http://forum.minecraft-galaxy.ru/registration/">Регистрация</a></li></ul><div class="content"><a class="top-block" href="http://forum.minecraft-galaxy.ru/guilogin/#" title="" target="">Вверх ↑</a><div class="frame"><div style="padding: 5px;"> </div><div class="center"><form action="http://forum.minecraft-galaxy.ru/login.php" method="post" class="line-form"><input type="hidden" name="form"><span><input type="hidden" name="ref" value="http://forum.minecraft-galaxy.ru/main/"></span> <span class="input"><span class="title">Логин</span> <input type="text" name="login" class="text"></span> <span class="input"><span class="title">Пароль</span> <input type="password" name="pass" class="text"></span><span><input type="hidden" name="fcode" value="30006947"></span>&nbsp;<input type="submit" value="Войти" class="btn"></form></div><div class="info-block"><div>Что делать, если не удается вспомнить пароль?</div><div style="padding: 5px;"><a class="" href="http://forum.minecraft-galaxy.ru/guilogin/1" title="" target="">выслать новый пароль на почту</a><br><a class="" href="http://forum.minecraft-galaxy.ru/guilogin/5" title="" target="">изменить пароль через авторизацию "ВКонтакте"</a><br><a class="" href="http://forum.minecraft-galaxy.ru/guilogin/9" title="" target="">изменить пароль через двухфакторную авторизацию</a><br></div></div></div></div>
...
<div style="padding:7px;">Copyright 2018 by minecraft galaxy team</div>
		...
		<div style="padding:7px;"> 
			...
			'height="31" width="88"><\/a>');if(11<js)d.write('<'+'!-- ');//--></script><a href="http://top.mail.ru/jump?from=1990623" target="_top"><img src="./guilogin_files/counter" alt="Рейтинг@Mail.ru" border="0" height="31" width="88"></a><!--  
		...
		<script src="./guilogin_files/watch.js.Без названия" type="text/javascript" defer="defer"></script>
		<noscript>&lt;div&gt;&lt;img src="//mc.yandex.ru/watch/12610318" style="position:absolute; left:-9999px;" alt="" /&gt;&lt;/div&gt;</noscript>
		<!-- /Yandex.Metrika counter -->
	<div style="padding:7px;"> 
		<a href="http://topcraft.ru/servers/4485" target="_blank"><img src="./guilogin_files/tops.png"></a>
		<a href="https://mctop.su/servers/1382/"><img src="./guilogin_files/tops(1).png"></a>
		<a href="http://mctop.pro/vote/2083-vote.html" target="_blank"><img src="./guilogin_files/3.png" alt="Проголосуй!"></a>
	</div>
...
<div style="display: none; " id="user-select">
	<div id="user-select-category">
		<div class="item" onclick="user_select_search();"><img class="item-icon" src="./guilogin_files/search.png"> Поиск</div>
		<div class="item" onclick="user_select_follow(5);"><img class="item-icon" src="./guilogin_files/twinks.png"> Твинки</div>
		<div class="item" onclick="user_select_follow(6);"><img class="item-icon" src="./guilogin_files/friends.png"> Друзья</div>
		<div class="item" onclick="user_select_follow(7);"><img class="item-icon" src="./guilogin_files/admins.png"> Администрация</div>
	</div>
	...
	<script type="text/javascript" src="./guilogin_files/highlight.pack.js.Без названия"></script>
	<script>
	...
	<link rel="stylesheet" href="./guilogin_files/map.css" type="text/css">
	<link rel="stylesheet" href="./guilogin_files/jquery-ui.css" type="text/css">
	<link rel="stylesheet" href="./guilogin_files/dark.css" type="text/css">
</div>
